        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UniversitySupervisors_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyId = table.Column<int>(type: "int", nullable: false),
                    CompanySupervisorId = table.Column<int>(type: "int", nullable: true),
                    UniversitySupervisorId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Internships_CompanySupervisors_CompanySupervisorId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Internships_UniversitySupervisors_UniversitySupervisorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attendances_Internships_InternshipId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Certificates_Internships_InternshipId",
                        column: x => x.InternshipId,
                        principalTable: "Internships",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FinalReports_Internships_InternshipId",
                        column: x => x.InternshipId,
                        principalTable: "Internships",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Grades_Internships_InternshipId",
                        column: x => x.InternshipId,
                        principalTable: "Internships",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OfferLetters_Internships_InternshipId",
                        column: x => x.InternshipId,
                        principalTable: "Internships",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_InternshipId_Date",
                table: "Attendances",
                columns: new[] { "InternshipId", "Date" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Certificates_InternshipId",
                table: "Certificates",
                column: "InternshipId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FinalReports_InternshipId",
                table: "FinalReports",
                column: "InternshipId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Grades_InternshipId",
                table: "Grades",
                column: "InternshipId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Internships_CompanySupervisorId",
                table: "Internships",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Internships_UniversitySupervisorId",
                table: "Internships",
                column: "UniversitySupervisorId");

            migrationBuilder.CreateIndex(
                name: "IX_OfferLetters_InternshipId",
                table: "OfferLetters",
                column: "InternshipId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UniversitySupervisors_UserId",
